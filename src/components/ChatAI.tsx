...
// Hapus simbol markdown umum dari respons AI (bold/italic/code/heading/list)
...
const ChatAI = () => {
  ...
  return (
    <div className="fixed bottom-16 sm:bottom-20 md:bottom-8 left-4 sm:left-6 z-[60]">
      {/* Floating Button */}
      <motion.button
            ...
            <div className="p-4 border-b border-border bg-muted/30 flex items-center justify-between shrink-0">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-muted-foreground leading-tight">Nexteam Router · free-forever</p>
                </div>
              </div>
              ...
              {isChatLoading ? (
                ...
                <div className="text-center py-10 space-y-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground px-6 text-pretty">Tanyakan apa saja seputar pengeluaran, tips trip, atau bantuan lainnya.</p>
                  </div>
                </div>
              ) : (
                messages.map((m, i) => (
